					...
					<div class="card bg-primary shadow-soft border-light p-4">
						<div class="card-body">
							...
							if (isset($_POST['proceed'])) {
								...
								remove($mysql, $id);
								echo "it kā tā arī nekad nebūtu...<br>
								<a href=\"etalons.php\" class=\"btn btn-block text-danger mr-2 mb-2\" type=\"button\">
							...
							<form method="POST">
								...
								<div class="form-group">
									<label>Vai jūs esat pilnībā pārliecinājušies ka tiešām vēlaties iznīcināt tieši šo eTalonu</label></br>
									<label>Ja jūs nožēlosiet par šo izvēli un vēlēsieties to atjaunot, to pašu eTalonu atgriezt nebūs iespējams līdz laika beigām</label></br>
									<label>Ja jūs esat pilnībā pārliecinājušies par šo izvēli tad nospiediet pogu "Turpināt"</label>
									<button type="submit"
										class="btn btn-block text-danger">Turpināt</button><br>
									<a href="etalons.php" class="btn btn-block text-danger mr-2 mb-2" type="button">Atpakaļ!</a>
